...
import { CurrencyInputPoolHeader } from 'views/Swap/components/CurrencyInputHeader'

const Body = styled(CardBody)`
  background-color: #f7f7f7; // ${({ theme }) => theme.colors.dropdownDeep};
`

const AddButton = styled(Button)`
  box-shadow: none;
  background-color: #fff !important;
  border: 2px solid #fed058;
  color: #000;
`
      ...
      <AppBody>
        ...
        <CardFooter style={{ textAlign: 'center' }}>
          <Link href="/add" passHref>
            <AddButton id="join-pool-button" width="100%" startIcon={<AddIcon color="#000" />}>
              {t('Add Liquidity')}
            </AddButton>
          </Link>
        </CardFooter>
